...
public class StudentChangePassword extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(OldPass, new org.netbeans.lib.awtextra.AbsoluteConstraints(475, 172, 223, 34));
        ...
        getContentPane().add(NewPass, new org.netbeans.lib.awtextra.AbsoluteConstraints(475, 224, 223, 34));
        ...
        getContentPane().add(ReTP, new org.netbeans.lib.awtextra.AbsoluteConstraints(475, 273, 223, 34));
        ...
        getContentPane().add(Okbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(609, 331, 65, 30));

        CurrentPass.setFont(new java.awt.Font("Maiandra GD", 0, 12)); // NOI18N
        CurrentPass.setForeground(new java.awt.Color(255, 0, 51));
        getContentPane().add(CurrentPass, new org.netbeans.lib.awtextra.AbsoluteConstraints(476, 140, 220, 20));

        newPass.setFont(new java.awt.Font("Maiandra GD", 0, 12)); // NOI18N
        newPass.setForeground(new java.awt.Color(255, 0, 51));
        getContentPane().add(newPass, new org.netbeans.lib.awtextra.AbsoluteConstraints(476, 140, 220, 20));

        Retp.setFont(new java.awt.Font("Maiandra GD", 0, 12)); // NOI18N
        Retp.setForeground(new java.awt.Color(255, 0, 51));
        getContentPane().add(Retp, new org.netbeans.lib.awtextra.AbsoluteConstraints(476, 140, 220, 20));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/appone/imagestudents/AppOneStudentChangePassword.png"))); // NOI18N
    ...
    private void OkbtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_OkbtnMouseClicked
         ...
         String sql1 ="UPDATE `users` SET `PASSWORD`='"+New+"' WHERE ID='"+pk+"'";
         try{
